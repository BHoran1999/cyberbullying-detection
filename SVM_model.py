...
#Remove all of the unecessary non sense being typed in the tweet that affects words
tweets_text = tweets_text.replace(r'\\n', '', regex=True)
...
SVM_classifier = SklearnClassifier(SVC(), sparse=False).train(train_index)
...
print("Support Vector Machine Cyberbullying Recall " , recall(train_set[1], test_set[1]))  
...
SVM_classifier = SklearnClassifier(SVC(), sparse=False).train(train_index2)
...
print("Support Vector Machine Cyberbullying Recall Bigram: ", recall(test_set[1], train_set[1]))
   


print()
print("Support Vector Machine Recall " , recall(train_set[1], test_set[1]))
print("Support Vector Machine Precision " , precision(train_set[1], test_set[1]))
print("Support Vector Machine F1-Score " , f_measure(train_set[1], test_set[1]))